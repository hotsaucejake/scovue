<template>
  <section>
    ...
    >
      ...
      <img class="w-8 h-8 rounded-full" src="/images/icons/bookmark.svg" alt="user avatar" />
    </button>
    <!-- Dropdown menu -->
    <div
    ...
    >
      <div class="py-3 px-4">
        <span class="block text-sm font-semibold text-gray-900 dark:text-white">Jot Sauce</span>
        <span class="block text-sm font-light text-gray-500 truncate dark:text-gray-400">name@jotsauce.com</span>
      </div>
      <ul class="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="user-dropdown">
        <li>

<template>
  <div
    ...
    tabindex="-1"
    aria-hidden="true"
    class="hidden overflow-y-auto overflow-x-hidden fixed top-4 sm:top-0 right-0 left-0 justify-center items-center w-[calc(100%-2rem)] sm:w-full md:inset-0 h-modal md:h-full"
    style="z-index: 100"
  >

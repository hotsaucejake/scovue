...
<template>
  <section
    class="w-full h-screen bg-center bg-cover bg-wood-section font-dosis-regular font-semibold text-slate-800 dark:text-slate-100 text-lg">
    <LoadingScreen v-if="isLoading"></LoadingScreen>
    <div
      class="w-full h-full bg-gradient-to-tr from-slate-100 dark:from-slate-800 flex justify-center items-center flex-col">
      <div class="flex justify-center">
        <div class="relative py-3 w-80 sm:max-w-xl md:max-w-2xl sm:mx-auto">
          ...
          <div
            class="block rounded-xl shadow-2xl bg-slate-100 dark:bg-slate-800 max-w-sm text-center transform skew-y-0 -rotate-6">
            <div
              class="py-5 px-6 text-6xl font-satisfy-regular font-black text-transparent bg-clip-text bg-gradient-to-br from-fuchsia-400 to-blue-400">
              login
            </div>
            <div class="px-6 mt-6">
              <div class="relative z-0 mb-6 w-full">
                <input v-model="authentication.email_or_username" type="email" name="email_or_username"
            ...
            <div class="px-6 mt-3">
              <div class="relative z-0 mb-6 w-full">
                <input v-model="authentication.password" type="password" name="password"
                  class="block py-2.5 px-3 w-full bg-transparent border-2 rounded-xl border-slate-400 appearance-none dark:border-slate-500 dark:focus:border-blue-400 focus:outline-none focus:ring-0 focus:border-blue-400 peer"
                  placeholder="" required />
                <label for="password"
